...
public class ClientController {
    ...
    @Autowired
    private MySecuredClient securedLoadBalancedClient;
    ...
    public CibilScore getCibilScore(@PathVariable("panNumber") String panCardNumber){
        return this.securedLoadBalancedClient.findCibilScore(panCardNumber);
    }
}
